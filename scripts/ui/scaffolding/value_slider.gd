...
func _apply_chrome() -> void:
	...
	_value_edit.custom_minimum_size = Vector2(_VALUE_FIELD_WIDTH, slider_size.y)
...
func _paint_slider_outline() -> void:
	...
	UiPalette.apply_outline(box, show_outline, outline_swatch, 1)
