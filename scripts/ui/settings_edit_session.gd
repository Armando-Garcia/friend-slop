...
func _pack_manager() -> Dictionary:
	return {
		...
		"voice_use_stub": SettingsManager.voice_use_stub,
		"lobby_voice_default": SettingsManager.lobby_voice_default,
		"dev_spawn_relic_near_spawn": SettingsManager.dev_spawn_relic_near_spawn,
...
func _apply_manager(data: Dictionary) -> void:
	...
	SettingsManager.voice_use_stub = bool(
		data.get("voice_use_stub", SettingsManager.voice_use_stub)
	)
	SettingsManager.lobby_voice_default = bool(
		data.get("lobby_voice_default", SettingsManager.lobby_voice_default)
	)
	SettingsManager.dev_spawn_relic_near_spawn = bool(
		data.get("dev_spawn_relic_near_spawn", SettingsManager.dev_spawn_relic_near_spawn)
	)
